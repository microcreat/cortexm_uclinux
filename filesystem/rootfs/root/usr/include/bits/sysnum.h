...
#undef __ARM_NR_atomicops
#define __ARM_NR_atomicops ((0 +0x0f0000)+0x800)
#define SYS_atomicops __ARM_NR_atomicops
#undef SYS_ARM_ATOMIC_SET
#define SYS_ARM_ATOMIC_SET 1
#define SYS__ATOMIC_SET SYS_ARM_ATOMIC_SET
#undef __NR_time
#undef __NR_umount
#undef __NR_stime
#undef __NR_alarm
