...
#if (CONFIG_SYS_BOARD_REV == 0x1A)
#define CONFIG_SYS_BOARD_REV_STR	"002"
#endif

/*
 * Monitor prompt
 */
#define CONFIG_SYS_PROMPT		"mic_lpc1788_s> "
...
#define CONFIG_HOSTNAME			mic_lpc1788_s
#define CONFIG_BOOTARGS			"lpc178x_platform=mic_lpc1788_s "\
